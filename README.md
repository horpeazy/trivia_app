...
This goal of this application is to create a bonding experiences for people. I got the idea to hold trivia on a regular basis and created a webpage to manage the trivia app and play the game, the main focus of the project is strengthning my skills on building out API'S.
